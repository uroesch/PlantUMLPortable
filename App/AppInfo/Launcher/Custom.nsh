...
Var PortableAppsBrowser

!macro FindPortableAppsBrowser
	ClearErrors
	...
	${Else}
		StrCpy $PortableAppsBrowser iexplore.exe
	${EndIf}
	${SetEnvironmentVariablesPath} PORTABLE_APPS_BROWSER $PortableAppsBrowser
!macroend
!define FindPortableAppsBrowser `!insertmacro FindPortableAppsBrowser`
...
${SegmentInit}
	...
	${OrIf} $JavaMode == require
		...
		${SetEnvironmentVariablesPath} JRE_HOME $JavaDirectory
	${ElseIfNot} ${Errors}
